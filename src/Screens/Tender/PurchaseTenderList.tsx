    ...
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.header}>
          <Text style={styles.heading}>Tender Purchase List</Text>
            ...
            >
              ...
              >
                ...
                <Text style={styles.subTitle}>
                  ...
                  <Text
                    style={{
                      color: item.tenderStatus === 'Opened' ? '#16A34A' : '#dc6f26ff',
                      fontWeight: '700',
                    }}
                  >
                    {item.tenderStatus === 'Opened' ? 'Open' : 'Approved'}
                  </Text>
                </Text>
              </TouchableOpacity>
              ...
              {expanded && (
                ...
                >
                  {/* {renderRow('', item.departmentName)} */}
                  {/* {renderRow('Pattern', item.auctionPattern)} */}
                  {renderRow('Fees', `₹ ${item.documentFees}`)}
                  {renderRow('Department', item.departmentName)}
      ...
      {/* Footer */}
      <TouchableOpacity disabled={Boolean(!SelectedPurchaseList.length)} style={[styles.proceedButton, { backgroundColor: Boolean(!SelectedPurchaseList.length) ? colors.lightText : colors.primary }]} onPress={() => { Navigation.navigate(NavigationString.ProceedToPurTender) }}>
...
export default PurchaseTenderList;
